...
vevet.pageLoad.onLoaded(function () {
    ...
    var makeSlider = function (_a) {
        var container = _a.container, className = _a.className, _b = _a.isThumb, isThumb = _b === void 0 ? false : _b, _c = _a.thumb, thumb = _c === void 0 ? undefined : _c, config = _a.config, _d = _a.paginationType, paginationType = _d === void 0 ? 'bullets' : _d, renderBullets = _a.renderBullets;
    ...
    var footerListenerHandler = function (wrapperArray) {
        wrapperArray.forEach(function (wrapper) {
            ...
            var gap = Math.floor(((widthWrapper - widthChildren) / (itemArray.length - 1)) * 100) / 100;
    ...
    var createSlide = function (date, index) {
        ...
        var slide = "\n    <div class='swiper-slide'>\n      <button \n        class='".concat(index === 0 ? 'active' : '', " input-container__button quiz-calendar-button'\n        data-value='").concat(monthLabel, " ").concat(day, "'>\n        <span class='quiz-calendar-button__month'>").concat(monthLabel, "</span>\n        <span class='quiz-calendar-button__day'>").concat(day, "</span>\n      </button>\n    </div>\n  ");
        return slide;
    };
    ...
    var inputRequieredHandler = function (slide) {
        ...
        requiredArray.forEach(function (input) {
            ...
            var doneTyping = function () {
                // console.log('done');
                var isAnyInputEmpty = !!Array.from(requiredArray).find(function (item) { return item.value === ''; });
    ...
    var buttonInputHandler = function (container) {
        ...
        buttonContainerArray.forEach(function (buttonContainer) {
            var buttonArray = buttonContainer.querySelectorAll('.input-container__button');
    ...
    var buttonContainerHandler = function (container, inputFormArray) {
        ...
        buttonContainerArray.forEach(function (buttonContainer) {
            var buttonActive = buttonContainer.querySelector('.input-container__button.active');
    ...
    var renderModalAnimation = function (_a) {
        ...
        if (scroll) {
            ...
            if (parent.classList.contains('popup-menu')) {
                ...
                element.style.transform = "translateY(".concat((easing - 1) * 2, "rem)");
            }
            else {
